...
MINIMUM_PYTHON = (3, 11)
SUITE_ID = "looper.fixture.config-driven"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Prepare the config-driven Looper fixture")
    ...
    marker = {
        ...
        "provides": ["config-driven-adapter"],
    }
