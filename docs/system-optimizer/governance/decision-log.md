...
| SO-D025 | 多 Agent 改为独立 worktree + 统一任务台账 + 主 agent 单点集成/push：每项任务登记唯一 ID、实际基线、依赖、写集合、验收和远端状态；工作 agent 不 push/merge；`delivered` 不等于接受，只有主 agent 独立验收并确认远端 commit 后才是 `pushed` | 2026-08-23 已发生跨 worktree 误写与过期基线误报；2026-08-24 新 G/D/Z 泳道又缺统一完成台账。用户要求统一接入、严格记录和修复历史记录 | confirmed 2026-08-24；登记本见 `planning/agent-work-ledger-2026-08-24.md` |
