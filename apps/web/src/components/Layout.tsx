import { Activity, Boxes, Braces, ChevronLeft, ClipboardList, Cloud, Gauge, GitCompareArrows, Menu, Plus, Server, SlidersHorizontal, TestTubeDiagonal, WandSparkles } from 'lucide-react';
