...
export function Layout() {
  ...
  return <OperatorAccessProvider><div className="app-shell">
    <aside className={`sidebar ${open ? 'open' : ''}`} aria-label="应用侧边栏">
      ...
      <div className="sidebar-bottom"><SelectionMenu onNavigate={() => setOpen(false)} /><div className="system-state"><span /><div><strong>控制平面正常</strong><small>API · {resolveApiUrl().host}</small></div></div></div>
    </aside>
