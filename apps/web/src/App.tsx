...
export function App(){return <Routes><Route element={<Layout/>}><Route index element={<DashboardPage/>}/><Route path="experiments" element={<ExperimentsPage/>}/><Route path="experiments/new" element={<CreateExperimentPage/>}/><Route path="experiments/:id" element={<ExperimentDetailPage/>}/><Route path="benchmarks" element={<BenchmarksPage/>}/><Route path="targets" element={<TargetsPage/>}/><Route path="cloud/market" element={<CloudMarketPage/>}/><Route path="cloud/quotes/:id" element={<CloudQuotePage/>}/><Route path="cloud/orders" element={<CloudOrdersPage/>}/><Route path="cloud/orders/:id" element={<CloudOrdersPage/>}/><Route path="*" element={<Navigate to="/" replace/>}/></Route></Routes>}
