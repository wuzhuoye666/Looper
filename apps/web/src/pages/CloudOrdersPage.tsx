...
function OrderDetail({ id }: { id: string }) {
  ...
  if (!order) return <div className="page"><ErrorState error={query.error} onRetry={() => query.refetch()} /></div>;
